...
public class GrafoPesado {
    ...
    public  void validarVertice(int posicionVertice){
        System.out.println(posicionVertice);
    ...
    public void insertarArista(int posVerticeOrigen,int posVerticeDestino,double costo)throws ExcepcionAristaYaExiste, ExcepcionAristaYaExiste {
    ...
    public void eliminarAristas(int posVerticeOrigen, int posVerticeDestino) throws ExcepcionAristaNoExiste, ExcepcionAristaNoExiste {
        validarVertice(posVerticeOrigen);
        validarVertice(posVerticeDestino);
        if (!this.existeAdayacencia(posVerticeOrigen, posVerticeDestino)) {
